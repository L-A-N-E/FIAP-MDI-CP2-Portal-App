  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.avatarContainer}>
        <TouchableOpacity onPress={pickImage} activeOpacity={0.8}>
          <View style={styles.avatarWrapper}>
            {loadingPhoto ? (
              ...
              <View style={[styles.avatar, styles.avatarPlaceholder]}>
                <Text style={styles.avatarTexto}>{user?.name?.[0]?.toUpperCase() ?? "?"}</Text>
              </View>
            )}
        ...
        <Text style={styles.nomeCompleto}>{user?.name} {user?.last_name}</Text>
      ...
      <View style={styles.logoutContainer}>
        <TouchableOpacity style={styles.botaoLogout} onPress={logout} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  badgeProfessor: { marginTop: 6, backgroundColor: "#FF0C5C", paddingHorizontal: 12, paddingVertical: 3, borderRadius: 20 },
  badgeTexto: { color: "#fff", fontSize: 12, fontWeight: "bold" },
  avatarContainer: { alignItems: "center", marginVertical: 20 },
  avatarWrapper: { position: "relative", marginBottom: 12 },
  avatar: { width: 100, height: 100, borderRadius: 50, borderWidth: 2, borderColor: "#FF0C5C" },
  avatarPlaceholder: { backgroundColor: "#FF0C5C", alignItems: "center", justifyContent: "center" },
  avatarTexto: { color: "#fff", fontSize: 36, fontWeight: "bold" },
  cameraIconContainer: { position: "absolute", bottom: 4, right: 4, backgroundColor: "#FF0C5C", width: 30, height: 30, borderRadius: 15, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#fff" },
  nomeCompleto: { fontSize: 20, fontWeight: "bold", color: "#171717" },
  emailTexto: { fontSize: 14, color: "#666", marginTop: 4 },
  card: { marginHorizontal: 20, backgroundColor: "#fff", borderRadius: 14, padding: 20, elevation: 3 },
  cardTitulo: { fontSize: 16, fontWeight: "bold", marginBottom: 16, color: "#FF0C5C" },
  ...
  botaoLogout: { backgroundColor: "#FF0C5C", paddingVertical: 14, borderRadius: 10, alignItems: "center" },
